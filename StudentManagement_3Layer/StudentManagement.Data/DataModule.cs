...
namespace StudentManagement.Data
{
    public class DataModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            RegisterRepository<UserEntity>(builder);
            RegisterRepository<CategoryEntity>(builder);
            RegisterRepository<RoleEntity>(builder);
            RegisterRepository<BlogEntity>(builder);
            RegisterRepository<CommentEntity>(builder);
            RegisterRepository<ImageEntity>(builder);
